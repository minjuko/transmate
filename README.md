...
<table>
  <tr>
    <td align="center">
      <img src="docs/images/readme/01-translation.jpg" alt="전문용어 번역 화면" width="260">
    </td>
    <td align="center">
      <img src="docs/images/readme/02-minutes.jpg" alt="회의록 관리 화면" width="260">
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td align="center">
      <img src="docs/images/readme/03-calendar.jpg" alt="일정 관리 화면" width="260">
    </td>
    <td align="center">
      <img src="docs/images/readme/04-summary.jpg" alt="회의 내용 요약 화면" width="260">
    </td>
  </tr>
  <tr>
...
비즈니스 회의에서 일반 번역이 전문용어의 맥락을 충분히 반영하지 못하는 문제에 주목했습니다. 초기에는 해상물류 분야를 중심으로 기획했으나, 프로젝트 진행 과정에서 활용 범위를 확장하여 **SW·금융·항만/무역 3개 분야의 전문용어를 지원**하도록 구성했습니다.

공공 전문용어 데이터를 분야별 데이터셋으로 구축하고 **AWS Translate Custom Terminology**에 적용하여, 사용자가 선택한 전문 분야의 용어가 번역 결과에 반영되도록 구현했습니다. 번역 대화는 회의록·요약·일정으로 관리할 수 있도록 구성했습니다.
...
공공 전문용어 데이터에서 서비스에 필요한 용어를 선별하고 형식을 통일한 뒤, **SW·금융·항만/무역 3개 분야**로 분류하여 `Source Term ↔ Target Term` 형태의 번역 용어 데이터를 구축했습니다.
...
- 데이터 정제 및 형식 통일
- SW·금융·항만/무역 분야 기준 데이터 분류
- `Source Term ↔ Target Term` 매핑
- AWS Custom Terminology 적용을 위한 데이터 형식 구성

<p align="center">
  <img src="docs/images/readme/terminology-dataset-example.png" alt="SW 금융 항만무역 전문용어 데이터셋 예시" width="850">
</p>
...
```mermaid
flowchart LR
    M[React Native Mobile] -->|HTTP / REST API| B[Spring Boot Backend on AWS EC2]
    B --> T[AWS Translate]
...
2023년 캡스톤디자인 당시 실제 모바일 환경에서 촬영한 시연 영상은 확인 후 업로드할 예정입니다.
...
> 상세 기술 문서의 공식 URL은 전체 포트폴리오 문서 정리 후 연결할 예정입니다.
