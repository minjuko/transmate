...
const SignInScreen = ({navigation, route}) => {
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      if (isSignUp) {
        try {
          const SignUpUrl = 'http://example.invalid:8080/account/create';
        ...
        try {
          const getFileUrl = `http://example.invalid:8080/meetings/${user.uid}`;
        ...
        try {
          const getScheduleUrl = `http://example.invalid:8080/schedules/${user.uid}`;
